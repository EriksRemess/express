...
describe("Router", function () {
  ...
  it("should support .use of other routers", async function () {
  ...
  it("should handle blank URL", async function () {
    var router = new Router();
  ...
  it("handle missing method", async function () {
    await new Promise((resolve, reject) => {
      var all = false;
      var router = new Router();
  ...
  describe("error", function () {
    it("should skip non error middleware", async function () {
      await new Promise((resolve, reject) => {
        var router = new Router();
    ...
    it("should handle throwing inside routes with params", async function () {
      await new Promise((resolve, reject) => {
        var router = new Router();
    ...
    it("should handle throwing in handler after async param", async function () {
      await new Promise((resolve, reject) => {
        var router = new Router();
  ...
  describe(".all", function () {
    it("should support using .all to capture all http verbs", async function () {
      await new Promise((resolve, reject) => {
        var router = new Router();
  ...
  describe(".use", function () {
    ...
    it("should be called for any URL", async function () {
      await new Promise((resolve, reject) => {
  ...
  describe(".param", function () {
    ...
    it("should call param function when routing VERBS", async function () {
      var router = new Router();
    ...
    it("should call param function when routing middleware", async function () {
      var router = new Router();
  ...
  describe("parallel requests", function () {
    it("should not mix requests", async function () {
      await new Promise((resolve, reject) => {
