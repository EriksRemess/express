...
class Accepts {
  ...
  encodings(...encodings) {
    ...
    const accepted = preferredEncodings(this.headers['accept-encoding'], normalized);
    const first = accepted[0];
  ...
  charsets(...charsets) {
    ...
    const accepted = preferredCharsets(this.headers['accept-charset'], normalized);
    const first = accepted[0];
  ...
  languages(...languages) {
    ...
    const accepted = preferredLanguages(this.headers['accept-language'], normalized);
    const first = accepted[0];
